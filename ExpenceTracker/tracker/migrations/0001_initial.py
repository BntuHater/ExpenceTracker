    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchase_date', models.DateField(auto_now_add=True, verbose_name='Date of purchase')),
                ('product_price', models.DecimalField(decimal_places=2, max_digits=9, verbose_name='Product price')),
